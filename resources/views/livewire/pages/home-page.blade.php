<div>
    ...
    <section
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 relative">
            <div class="max-w-3xl">
                <p class="text-primary-200 font-medium text-sm tracking-wider uppercase mb-4 animate-slide-in-left delay-100">{{ $jumbotron['hero_label'] }}</p>
                <h1 class="text-4xl lg:text-5xl xl:text-6xl font-extrabold text-white leading-tight mb-6 animate-slide-in-left delay-200">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-10">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 stagger-children">
            @php
                $quickLinks = [
                    ['icon' => 'cloud', 'label' => 'Layanan Publik', 'color' => 'bg-blue-500'],
                    ['icon' => 'language', 'label' => 'Portal E-Gov', 'color' => 'bg-emerald-500'],
                    ['icon' => 'campaign', 'label' => 'Pengumuman', 'color' => 'bg-amber-500'],
                    ['icon' => 'description', 'label' => 'Publikasi', 'color' => 'bg-purple-500'],
                ];
            @endphp
    ...
    @if ($leader)
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
            <div class="text-center mb-10 animate-on-scroll">
                <p class="text-primary-600 font-semibold text-sm tracking-wider uppercase mb-2">{{ $leader_profile_subtitle }}</p>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        ...
        <p class="text-slate-600 mb-8 max-w-2xl animate-on-scroll">Akses dokumen resmi, laporan tahunan, dan regulasi terkini terkait
